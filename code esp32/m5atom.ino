...
// ==================== CONFIGURATION WiFi ====================
const char* WIFI_SSID = "CPNV-BYOD";
...
const char* RASPBERRY_IP = "10.229.56.36";  // A modifier selon votre Raspberry Pi
const char* RASPBERRY_PORT = "5000";
const bool USE_LOCAL_SERVER = true;  // Mettre false pour desactiver

// ==================== CONFIGURATION Capteur ====================
const char* CAPTEUR_ID = "ATOM_002";  // Identifiant unique de ce capteur
...
void sendToLocalServer(float temperature, float humidite, float pression) {
    ...
    String url = "http://" + String(RASPBERRY_IP) + ":" + String(RASPBERRY_PORT) + "/request/";
